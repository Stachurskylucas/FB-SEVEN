          ...
          <ScrollReveal direction="up" duration={0.8} className="text-center">
            <div className="bg-[#0b1019] border border-brand-neon/30 rounded-3xl p-8 sm:p-12 shadow-[0_0_50px_rgba(0,242,254,0.15)] relative overflow-hidden">
              ...
              <button
                type="button"
                onClick={() => handleOpenBooking()}
                className="btn-tactile inline-flex items-center gap-2.5 px-8 py-4 rounded-2xl bg-brand-neon hover:bg-white text-black font-extrabold text-sm uppercase tracking-wider shadow-[0_0_25px_rgba(0,242,254,0.4)] transition-all cursor-pointer relative z-10"
              >
                <Calendar className="w-4 h-4" />
